...
public class CustomShapedRecipe extends ShapedRecipes implements IRecipe {
	...
	public ItemStack a(InventoryCrafting inv) {
		...
		org.bukkit.inventory.ItemStack[] inventory = new org.bukkit.craftbukkit.inventory.CraftItemStack[inv
		                                                                                                        .getSize()];
	 ...
	 *
	 * @param name
	 * name of recipe. Useful in event.
	 * @param item1
	 * returned in recipe item.
	 * @param args
	 * Arguments
	 * @return the custom shaped recipe. Note that recipe is automatically added
	 * to CraftingManager.
	 */
