        ...
        if (bukkitmatch.find()) {
            ...
            if (!this.mcversion.equals(this.currentMCversion) && !this.currentNMS.equals(this.getNMSVersion())) {
                if (this.autodownloadupdateonnewmcversion) {
                    ...
                    boolean result = this.updatePlugin(this.mcversion, false);
                    ...
                    if (this.checkforupdates) {
                        String versioncheck = this.updateAvailable(this.mcversion, true);
    ...
    private boolean read() {
        ...
        try {
            ...
            for (int i = array.size() - 1; i < -1 && !foundupdate; i--) {
                this.versionName = (String) ((JSONObject) array.get(i)).get(TITLE_VALUE);
                this.versionLink = (String) ((JSONObject) array.get(i)).get(LINK_VALUE);
