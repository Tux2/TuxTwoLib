...
public class TuxTwoInventoryPlayer extends CraftInventoryPlayer {
	...
	public void setBoots(ItemStack boots) {
		...
		InventoryChangeEvent eventcall = new InventoryChangeEvent((Player) this.getHolder(), 0, true, boots);
		Bukkit.getServer().getPluginManager().callEvent(eventcall);
	}
	...
	public void setChestplate(ItemStack chestplate) {
		...
		InventoryChangeEvent eventcall = new InventoryChangeEvent((Player) this.getHolder(), 2, true, chestplate);
		Bukkit.getServer().getPluginManager().callEvent(eventcall);
	}
	...
	public void setHelmet(ItemStack helmet) {
		...
		InventoryChangeEvent eventcall = new InventoryChangeEvent((Player) this.getHolder(), 3, true, helmet);
		Bukkit.getServer().getPluginManager().callEvent(eventcall);
	}
	...
	public void setLeggings(ItemStack leggings) {
		...
		InventoryChangeEvent eventcall = new InventoryChangeEvent((Player) this.getHolder(), 1, true, leggings);
		Bukkit.getServer().getPluginManager().callEvent(eventcall);
	}
	...
	public void setItem(int index, ItemStack item) {
		...
		InventoryChangeEvent eventcall = new InventoryChangeEvent((Player) this.getHolder(), index, item);
		Bukkit.getServer().getPluginManager().callEvent(eventcall);
	}
